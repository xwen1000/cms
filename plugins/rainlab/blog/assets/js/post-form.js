+function ($) { "use strict";
    ...
    $(document).ready(function(){
        ...
        var cates=$("input[id^='checkbox_Form-field-Post-categories_']")
        cates.each(
            function(i,e){

                $("#"+e.id).change(function() {
                    $('#post-form').request('onCategorychanged', {success: function(data) {
                            var full_awords=$("input[id^='checkbox_Form-field-Post-awords_']")
                            var arr = Object.values(data);
                            full_awords.each(
                                function(ii,ee){
                                    if($.inArray(parseInt(ee.value),arr) == -1 )
                                    {
                                    ...
                                    {
                                        console.log(ee.value);
                                        ee.parentNode.style.display="block";
                                    }
                                }
                                )
                    }});
